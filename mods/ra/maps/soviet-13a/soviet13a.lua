...
StartAttack = { StartAttack1, StartAttack2, StartAttack3, StartAttack4, StartAttack5, StartAttack6, StartAttack7, StartAttack8 }
...
WorldLoaded = function()
	...
	TakeDownRadar = USSR.AddObjective("Destroy the Allied radar sites before approaching\nthe chronoshpere.")
	CaptureChronosphere = USSR.AddObjective("Capture the chronoshpere.")
